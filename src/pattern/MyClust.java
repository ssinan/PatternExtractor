...
public class MyClust {
    ...
    public MyClust(ByteArrayOutputStream os, String rate, String hdThr, String hhdThr) {
        readSolution(os);
    ...
    private void readSolution(ByteArrayOutputStream os) {
